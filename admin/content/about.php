...
<div class="row" id="contain-isi">
  ...
  $query=mysql_query("SELECT * FROM about");
   ?>
  <form class="" action="proses/p-about.php" method="post" enctype="multipart/form-data">
    ...
    <div class="input-field col s12 m12">
      ...
      <textarea id="text-editor" placeholder="Deskripsi" name="dess" rows="8" cols="80" required placeholder="Deskripsi"></textarea>
      <script type="text/javascript">
       CKEDITOR.replace("text-editor");
      </script>
    </div>

    <div class="btn-form-admin-about">
...
<table id="" class="display striped" cellspacing="0" width="100%">
    ...
    <tbody>
        <tr>
            <td><img src=images/about/<?php echo $row['foto']; ?> width="50"height="50"></td>
            <td><?php echo substr($row['dess'],0,80).".."; ?></td>
            <td class="center">
              <a class="waves-effect waves-light btn blue" href="index.php?show=u-about&id=<?php echo $row['id']; ?>">Edit</a>
            </td>
        </tr>
        <?php
        }
