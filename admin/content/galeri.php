...
<div class="row" id="contain-isi">
  ...
  $query=mysql_query("SELECT * FROM galeri");
   ?>
  <form class="" action="proses/p-galeri.php" method="post" enctype="multipart/form-data">
    ...
    <div class="btn-form-admin-galeri">
...
<table id="" class="display striped" cellspacing="0" width="100%">
    ...
    <tbody>
        <tr>
            <td><img src=images/galeri/<?php echo $row['foto']; ?> width="50"height="50"></td>
            <td><?php echo $row['judul'] ?></td>
            <td class="center"><a class="waves-effect waves-light btn blue" href="index.php?show=u-galeri&id=<?php echo $row['id']; ?>">Edit</a></td>
        </tr>
        <?php
        }
        ?>
